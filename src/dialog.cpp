...
void undertale(GameState* state, int dialog) {
	...
	case 8:
		DIALOG(SPEAKER_NARRATOR,
		       "You go through the airlock and board the ship.", true);
		break;
	case 9:
		ENDDIALOGUEP;
	...
	case 1'01'008:
		...
		// day 1: flag 0: is the phone ringing? if flag 1 is on, the ringing
		// stops.
		break;
	case 1'01'009:
		DIALOG("You",
	...
	case 1'01'100:
		DIALOG(SPEAKER_NARRATOR,
		       "I pickup the phone and hold the receiver" LINE
		       "next to my ear.",
		       true);
		PFLAG[1] = true;
		break;
	...
	case 1'01'111:
		DIALOGS("Phone",
		        "*click*              " LINE "*BEEEEEEEEP* *BEEEEEEEEP*", true,
		        DIALOG_SOUND::NONE);
		break;
	case 1'01'112:
		DIALOG(SPEAKER_NARRATOR,
	...
	case 1'01'300:
		DIALOG(SPEAKER_NARRATOR, "Not now, I need to read the book first.",
		       false);
		break;
	...
	case 1'01'603:
		...
		break;
	case 1'01'604:
		DIALOG(SPEAKER_NARRATOR, "The Manager quickly hung up after that.",
		       true);
		break;
	...
	case 1'04'100:
		DIALOG(SPEAKER_NARRATOR,
		       "Cafeteria Kitchen. Authorized Personnel Only.", false);
		if (PFLAG[3]) {
	...
	case 1'04'200:
		DIALOG(SPEAKER_NARRATOR,
		       "I try to open the airlock, but it doesn't budge.", false);
		break;
	...
	case 2'04'100:
		...
		// state->transition.transitionTime =
		// state->transition.maxTransitionTime; update: breaking news: me is
		// certified dumbass
